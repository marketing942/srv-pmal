export default function Solution() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-cppem-line py-16 sm:py-20">
      <div className="absolute -left-24 top-1/3 h-72 w-72 rounded-full bg-cppem-green/10 blur-3xl" />
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="section-title mt-4">
              ...
              <span className="text-cppem-green">É revisar com inteligência.</span>
            </h2>
          ...
          <div className="relative">
            <div className="rounded-2xl border border-cppem-green/30 bg-cppem-graphite/80 p-8 shadow-glow">
              <p className="font-display text-2xl font-bold uppercase leading-tight tracking-tight text-white sm:text-3xl">
                ...
                <span className="text-cppem-green">confusão</span>.
                <br />
                Precisa de{" "}
                <span className="text-cppem-green">estratégia</span>.”
              </p>
              <div className="mt-6 flex items-center gap-3 border-t border-cppem-line pt-5">
                <div className="h-10 w-10 rounded-full border border-cppem-green/40 bg-cppem-green/10" />
                <div>
                  <p className="text-sm font-semibold text-white">
                    Prof. Everton Mota
                  </p>
                  <p className="text-xs uppercase tracking-wider text-cppem-green/80">
                    CPPEM Concursos
                  </p>
                </div>
              </div>
...
function Check() {
  return (
    <span className="mt-1 inline-flex h-5 w-5 flex-none items-center justify-center rounded-full bg-cppem-green/15 text-cppem-green">
      <svg
        width="12"
        height="12"
        viewBox="0 0 24 24"
