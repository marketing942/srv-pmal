...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      aria-label="Falar com a equipe CPPEM no WhatsApp"
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-2 sm:bottom-6 sm:right-6"
    >
      <span className="hidden whitespace-nowrap rounded-full bg-pmal-navyDark/90 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-white shadow-lg ring-1 ring-pmal-gold/30 sm:block">
        Fale conosco
      </span>
